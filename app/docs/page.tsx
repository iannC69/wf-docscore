      ...
      <section className="docs-home-hero">
        ...
        <div className="docs-home-search-hint">
          <div className="search-hint-left">
            ...
            <span>Press <kbd>⌘K</kbd> or <kbd>Ctrl+K</kbd> anywhere to search documentation</span>
          </div>
        ...
        <div className="home-features-list">
          <div className="feature-item">
            ...
            <div className="feature-item-content">
              <h4 className="feature-item-title">Next.js 15 App Router &amp; SSG</h4>
          ...
          <div className="feature-item">
            ...
            <div className="feature-item-content">
              <h4 className="feature-item-title">Shiki Server Syntax Highlighting</h4>
              <p className="feature-item-desc">
          ...
          <div className="feature-item">
            ...
            <div className="feature-item-content">
              <h4 className="feature-item-title">Type-Safe Content Layer</h4>
              <p className="feature-item-desc">
          ...
          <div className="feature-item">
            ...
            <div className="feature-item-content">
              <h4 className="feature-item-title">Customizable Design System</h4>
              <p className="feature-item-desc">
